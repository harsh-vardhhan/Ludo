...
// Define paths for each player using their IDs
class PathManager {
  static final Map<String, List<String>> _playerPaths = {
    'BP': blueTokenPath,
    'GP': greenTokenPath,
  };

  // Method to get the path for a specific player
  static List<String> getPathForPlayer(String playerId) {
